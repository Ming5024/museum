Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: "https://www.sysubm.com/search/animal",
      data: {
        specId: this.id,
      ...
      success: function(res) {
        ...
        that.setData({
          ...
          exhibit_information: {
            ...
            order: order,
            order_description: res.data.order_des === null ? "" : res.data.order_des,
            family: family,
            family_description: res.data.family_des === null ? "" : res.data.family_des,
            genus: genus,
